...
select3="(3) LP1 20W LP2 40W [Small increase]"
select4="(4) LP1 25W LP2 40W [PRO Recommend]"
...
if [[ "${systemLanguage}" == "zh_CN" ]]; then
    ...
    select3="(3) LP1 20W LP2 40W 小幅提升"
    select4="(4) LP1 25W LP2 40W PRO 推荐"
...
function command1() {
    sudo "$position"/voltageshift powerlimit $LP1 28 44 0.001
}
function command2() {
...
function command6() {
    sudo "$position"/voltageshift buildlaunchd $volta $volta 0 0 0 0 $LP1 28 40 0.001 60
}
